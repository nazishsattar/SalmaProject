   ...
   <div class="container">
         <div class="wrap-breadcrumb">
             <ul>
                 ...
                 <li class="item-link"><span>Salma Supermarket</span></li>
             </ul>
         </div>
         <div class="row">
             <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
               <div class="row" wire:ignore>
                    ...
                    <div class="home-grid-slider slider-dots">
                        <div class="col-lg-8 order-0 order-lg-1 order-xl-1">
                            <div class="home-grid-slider slider-arrow slider-dots">
                                ...
                                <a href="#"><img src="{{asset('assets/images/promo/grid/03.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/04.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/05.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/06.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/07.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/08.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/09.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/10.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/11.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/12.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/13.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/14.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/15.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/16.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/17.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/18.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/19.jpeg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/20.jpg')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/promo/grid/21.jpg')}}" alt=""></a>
                            </div>
                        </div>
                 ...
                 <div class="wrap-shop-control">
                     <h1 class="shop-title">Biggest Supermarket</h1>
                         ...
                         <div class="con-w3l">
                             ...
                             <div class="col-md-3 m-wthree">
                                 <div class="product-card">								
                                     ...
                                     <div class="mid-1">
                                         <div class="women">
                                             <h6 style="font-weight: bold;"><a href="{{route('product.details',['slug'=>$product->slug])}}" class="product-name">{{$product->name}}</a></h6>
                           ...
                           <ul class="new-slider slider-arrow">
                               ...
                               <li>
                                   <div class="product-card">								
                                       ...
                                       <div class="mid-1">
                                           <div class="women">
                                               <h6 style="font-weight: bold;"><a href="{{route('product.details',['slug'=>$lproduct->slug])}}" class="product-name">{{$lproduct->name}}</a></h6>
