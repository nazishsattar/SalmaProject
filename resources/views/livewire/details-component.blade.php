                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-butons">
                            @if($product->sale_price >0 && $sale->status==1 && $sale->sale_date>Carbon\Carbon::now())
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{addslashes($product->name)}}',{{$product->sale_price}})">Add to Cart</a>
                            @else
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{addslashes($product->name)}}',{{$product->regular_price}})">Add to Cart</a>
                            @endif
                            <br>
                            <div class="wrap-btn" >   
                                <style>
                                ...
                                <a href="#" class="abc" style="color:#e40c14;font-size:14px;"  wire:click.prevent="removeFromWishlist({{$product->id}})"><i class="fa fa-heart fill-heart"></i> Add to Wishlist</a>
                                @else
                                <a href="#"  class="abc" style="color:#666666;font-size:14px;"  wire:click.prevent="addToWishlist({{$product->id}},'{{addslashes($product->name)}}',{{$product->regular_price}})"> <i class="fa fa-heart "></i> Add to Wishlist</a>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <li class="service">
                                <a class="link-to-service" href="#">
                                    ...
                                    <div class="right-content">
                                        <b class="title">Not Free Shipping</b>
                                        <span class="subtitle">Depend on Distance</span>
                                        <p class="desc">Shipping amount will be depend on distance...</p>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="service">
                                <a class="link-to-service" href="#">
                                    ...
                                    <div class="right-content">
                                        ...
                                        <p class="desc">Get Different Gifts from Salma Super Market...</p>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="service">
                                <a class="link-to-service" href="#">
                                    ...
                                    <div class="right-content">
                                        ...
                                        <p class="desc">We aim to provide the best experience of our valuable customers by offering easy Return and Exchange Policies</p>
                                    </div>
                                </a>
                            </li>
                        </ul>
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route('product.details',['slug'=>$r_product->slug])}}" title="{{$r_product->name}}">
                                        <figure><img src="{{asset('assets/images/products')}}/{{$r_product->image}}" width="85" height="85" alt="{{$r_product->name}}"></figure>
                                    </a>
