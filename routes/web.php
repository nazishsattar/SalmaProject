...
Route::get('/wishlish',WishlistComponent::class)->name('product.wishlist');
Route::get('/thank-you',ThankyouComponent::class)->name('thankyou');
Route::get('/contact-us',ContactComponent::class)->name('contactus');
// Route::post('/remove-from-wishlist',[CustomerWishlistController::class,'removeFromWishlist'])->name('wishlist.remove-item');
// Route::middleware([
//     'auth:sanctum',
...
//Links for normal user or customer
